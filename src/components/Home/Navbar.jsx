...
import Logo from "../../assets/images/ldce-logo-crop.png"
        ...
        <div className="wrapper">
          <div className="logo flex gap-x-2 items-center justify-center">
            ...
            <div className=" flex flex-col items-start justify-center pt-2">
              <h1 className=" text-2xl font-black -mb-3 select-none" style={{ fontFamily: 'serif' }}>L.D. College of Engineering</h1>
              <h3 className=" text-sm font-light mt-2 select-none " style={{ fontFamily: 'monospace' }}>Ahmedabad,Gujarat,India</h3>
            </div>
          </div>
